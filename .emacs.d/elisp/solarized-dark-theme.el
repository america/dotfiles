...
(custom-theme-set-faces
 'solarized-dark
  '(default ((t (:background "#002b36" :foreground "#657b83")))) ;; fg
  ;; "should" be #657b83 93a1a1
   '(cursor ((t (:background "#586e75" :foreground "#93a1a1")))) ;; fg
   ;; "should" be #93a1a1 657b83
   ...
   '(isearch ((t (:foreground "#b58900" :inverse-video t))))
    '(lazy-highlight ((t (:background "#073642")))) ; second
                                        ; highlight, typ?
